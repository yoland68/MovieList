...
/**
 * Created by yolandyan on 2/24/16.
 */
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        Log.d("#YOLAND", "Sunshine Service initiated");
        String loc = intent.getStringExtra(LOCATION_TAG);
        // If there's no zip code, there's nothing to look up.  Verify size of params.
        if (loc == null) {
            Log.e(LOG_TAG, "No string input in the intent");
            return;
        }
